...
type DogeScreenProps = StackScreenProps<ParamListBase> & DogeProps;
...
function Screen1({route, navigation}: StackScreenProps<ParamListBase>) {
  return (
    <DogeScreen
      route={route}
...
function Screen3({route, navigation}: StackScreenProps<ParamListBase>) {
  return (
    <DogeScreen
      route={route}
      navigation={navigation}
...
function Screen4({route, navigation}: StackScreenProps<ParamListBase>) {
  return (
    <DogeScreen
      route={route}
      navigation={navigation}
